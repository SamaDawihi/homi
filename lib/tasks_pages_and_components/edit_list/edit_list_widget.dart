    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.membersToBeAdded =
            widget.listDoc!.assignedTo.toList().cast<DocumentReference>();
      });
      _model.numberOfFamilyMembers = await queryMemberRecordCount(
      ...
      setState(() {
        _model.currentNumberOfFamilyMembers = _model.numberOfFamilyMembers!;
      });
    });
