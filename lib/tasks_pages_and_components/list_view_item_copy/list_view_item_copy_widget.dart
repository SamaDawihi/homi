...
import 'list_view_item_copy_model.dart';
export 'list_view_item_copy_model.dart';

class ListViewItemCopyWidget extends StatefulWidget {
  const ListViewItemCopyWidget({
    Key? key,
  ...
  @override
  _ListViewItemCopyWidgetState createState() => _ListViewItemCopyWidgetState();
}

class _ListViewItemCopyWidgetState extends State<ListViewItemCopyWidget> {
  late ListViewItemCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListViewItemCopyModel());
  }
