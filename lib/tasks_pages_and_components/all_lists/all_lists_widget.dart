                        ...
                        tabs: [
                          Tab(
                            text: FFLocalizations.of(context).getText(
                              '4n5krc0e' /* Shopping Lists */,
                            ),
                          ),
                          Tab(
                            text: FFLocalizations.of(context).getText(
                              'm4twvzo7' /* To-Do Lists */,
                            ),
                          ),
                        ],
                                          ...
                                          itemBuilder:
                                            ...
                                            return wrapWithModel(
                                              ...
                                              updateCallback: () =>
                                                  setState(() {}),
                                              child:
                                                  ListComponentViewListWidget(
                                                key: Key(
                                                  'Key34u_${listViewIndex.toString()}',
                                                ),
                                                listRef: listViewListRecord
                                                    .reference,
                                              ),
                                            );
                                          },
                                          ...
                                          itemBuilder:
                                            ...
                                            return wrapWithModel(
                                              ...
                                              child:
                                                  ListComponentViewListWidget(
                                                key: Key(
                                                  'Keyn2c_${listViewIndex.toString()}',
                                                ),
                                                listRef: listViewListRecord
                                                    .reference,
                                              ),
