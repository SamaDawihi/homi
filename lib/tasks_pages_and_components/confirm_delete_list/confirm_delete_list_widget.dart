...
class ConfirmDeleteListWidget extends StatefulWidget {
  ...
  @override
  _ConfirmDeleteListWidgetState createState() =>
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'gsrvx6y2' /* Are you sure you want to delet... */,
                        ),
                        style:
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        _model.items = await queryItemRecordOnce(
                          queryBuilder: (itemRecord) => itemRecord.where(
                            'belongTo',
                            isEqualTo: widget.belongTo,
                          ),
                        );
                        while (_model.loopIteration < _model.items!.length) {
                          await _model.items![_model.loopIteration].reference
                              .delete();
                          setState(() {
