                              ...
                              builder: (context) {
                                return GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child:
                                        InputComponentEnterFamilyNameWidget(),
                                  ),
                                );
                              },
                            ).then((value) => safeSetState(() {}));
                      ...
                      if (listViewMemberRecordList.isEmpty) {
                        return Center(
                          child: Container(
                            width: 500.0,
                            height: 200.0,
                            child: ListViewEmptyFamiliesWidget(),
                          ),
                        );
                      }
                      return ListView.builder(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return wrapWithModel(
                            model: _model.listViewMyFamilyModels.getModel(
                              listViewIndex.toString(),
                              listViewIndex,
                            ),
                            updateCallback: () => setState(() {}),
                            child: ListViewMyFamilyWidget(
                              key: Key(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (listViewInvitationRecordList.isEmpty) {
                        return Container(
                          width: 500.0,
                          height: 200.0,
                          child: ListViewEmptyInvitationsWidget(),
                        );
                      }
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return wrapWithModel(
                            model: _model.listViewRecievedInvitationModels
                                .getModel(
                              listViewIndex.toString(),
                              listViewIndex,
                            ),
                            updateCallback: () => setState(() {}),
                            child: ListViewRecievedInvitationWidget(
                              key: Key(
