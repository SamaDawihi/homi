...
import 'dialog_invite_sent_successfully_model.dart';
...
class _DialogInviteSentSuccessfullyWidgetState
    extends State<DialogInviteSentSuccessfullyWidget> {
  late DialogInviteSentSuccessfullyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DialogInviteSentSuccessfullyModel());
  }
