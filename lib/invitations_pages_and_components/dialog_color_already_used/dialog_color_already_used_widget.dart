...
import 'dialog_color_already_used_model.dart';
...
class _DialogColorAlreadyUsedWidgetState
    extends State<DialogColorAlreadyUsedWidget> {
  late DialogColorAlreadyUsedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DialogColorAlreadyUsedModel());
  }
