  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().familyId == null) {
        ...
        _model.familyDocument =
            await FamilyRecord.getDocumentOnce(FFAppState().familyId!);
        return;
      }
    });
  }
                ...
                Align(
                  ...
                  child: Text(
                    valueOrDefault<String>(
                      _model.familyDocument?.name,
                      'No Family Selected Return to Home',
                    ),
                  ...
                  children: [
                    Align(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          if (_model.familyDocument?.adminId ==
                  ...
                  child: StreamBuilder<List<MemberRecord>>(
                    stream: queryMemberRecord(
                      queryBuilder: (memberRecord) => memberRecord.where(
                          'familyId',
                          isEqualTo: _model.familyDocument?.reference),
                    ),
                    builder: (context, snapshot) {
                      ...
                      List<MemberRecord> familyMembersListViewMemberRecordList =
                          snapshot.data!;
                      return ListView.builder(
                        ...
                        itemCount: familyMembersListViewMemberRecordList.length,
                        itemBuilder: (context, familyMembersListViewIndex) {
                          ...
                          return wrapWithModel(
                            model: _model.familyMemberContainerModels.getModel(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('InvitationsStatus');
                                    },
                                    text: FFLocalizations.of(context).getText(
                                      'n7mptuv2' /* view status */,
                                    ),
                                    options: FFButtonOptions(
                                      height: 40.0,
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                                ...
                                                builder: (alertDialogContext) {
                                                  return AlertDialog(
                                                    title: Text(
                                                        'Delete the Family'),
                                                    content: Text(
                                                        'by continuing all family data will be lost'),
                                                    actions: [
                                                      TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
