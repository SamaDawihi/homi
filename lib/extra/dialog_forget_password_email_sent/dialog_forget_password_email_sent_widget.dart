...
import 'dialog_forget_password_email_sent_model.dart';
...
class _DialogForgetPasswordEmailSentWidgetState
    extends State<DialogForgetPasswordEmailSentWidget> {
  late DialogForgetPasswordEmailSentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DialogForgetPasswordEmailSentModel());
  }
